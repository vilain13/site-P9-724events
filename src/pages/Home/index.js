...
const Page = () => {
  ...
  return <>
    ...
    <main>
      ...
      <section id="nos-services" className="ServicesContainer">  {/* Ajout de l'id pour le lien du menu navigation */}
      ...
      <section id="nos-realisations" className="EventsContainer">   {/* Ajout de l'id pour le lien du menu navigation */}
        <h2 className="Title">Nos réalisations</h2>
        <EventList />
      </section>
      <section id="notre-equipe" className="PeoplesContainer">    {/* Ajout de l'id pour le lien du menu navigation */}
